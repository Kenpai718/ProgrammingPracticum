...
public final class FileLoader {
	 ...
	 */
	public static PropertyChangeEnabledRoadRageControls readCity(
	...
	private static List<Vehicle> readVehicles(final Scanner theInput) {
		...
		for (int lineCount = 0; lineCount < numVehicles; lineCount++) {
			...
			// Ken Note: below are specific test cases when using map 1

			// taxi will go to 2 crosswalks here
			/*
			 * case 'X': vehicles.add(new Taxi(3, 1, Direction.WEST)); break;
			 */
			
				
			//bike will go through most of map1
			/*
			 * case 'B': vehicles.add(new Bicycle(vehicleX, vehicleY,
