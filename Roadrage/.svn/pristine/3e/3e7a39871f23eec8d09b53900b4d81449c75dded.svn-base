...
public class TruckTest {
	...
	/**
	 * Test of truck with negative x
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testTruckConstructorNegativeX() {
		new Truck(-1, 0, Direction.NORTH);
	}

	/**
	 * Test of truck with negative y
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testTruckConstructorNagativeY() {
		new Truck(0, -1, Direction.NORTH);
	}

	/**
	 * Test of truck null direction
	 */
	@Test(expected = NullPointerException.class)
	public void testItemConstructorNullDirection() {
		new Truck(0, 0, null);
	}
	...
	/**
	 * Test method to ensure truck passes all lights except for red crosswalks.
	 * 
	 */
	@Test
